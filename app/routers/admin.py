...
'''
@router.get("/get_user/{id}", status_code=status.HTTP_200_OK, response_model=schemas.UserResponse)
def get_user(
    id: int,
    db: Session = Depends(get_db),
    current_user: int = Depends(oauth2.get_current_user)
...
current user must be admin user
'''
@router.get("/get_users", status_code=status.HTTP_200_OK, response_model=List[schemas.UserResponse])
def get_users(
    db: Session = Depends(get_db),
    current_user: int = Depends(oauth2.get_current_user)
):
...
'''
@router.put("/toggle_active/{id}", status_code=status.HTTP_200_OK, response_model=schemas.UserResponse)
def toggle_active(
    id: int,
    db: Session = Depends(get_db),
    current_user: int = Depends(oauth2.get_current_user)
...
'''
@router.put("/toggle_admin/{id}", status_code=status.HTTP_200_OK, response_model=schemas.UserResponse)
def toggle_admin(
    id: int,
    db: Session = Depends(get_db),
    current_user: int = Depends(oauth2.get_current_user)
...
current user must be admin user
'''
@router.get("/generate_token/{id}", status_code=status.HTTP_200_OK, response_model=schemas.ApiToken)
def generate_token(
    id: int,
    db: Session = Depends(get_db),
    current_user: int = Depends(oauth2.get_current_user)
